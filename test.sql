...
VALUES ('20230606105654_InitCreate', '7.0.7');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230616144638_IdentityAdded', '7.0.7');

COMMIT;

BEGIN TRANSACTION;

CREATE TABLE "ActivityAtendees" (
    "AppUserId" TEXT NOT NULL,
    "ActivityId" TEXT NOT NULL,
    "IsHost" INTEGER NOT NULL,
    CONSTRAINT "PK_ActivityAtendees" PRIMARY KEY ("AppUserId", "ActivityId"),
    CONSTRAINT "FK_ActivityAtendees_Activities_ActivityId" FOREIGN KEY ("ActivityId") REFERENCES "Activities" ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_ActivityAtendees_AspNetUsers_AppUserId" FOREIGN KEY ("AppUserId") REFERENCES "AspNetUsers" ("Id") ON DELETE CASCADE
);

CREATE INDEX "IX_ActivityAtendees_ActivityId" ON "ActivityAtendees" ("ActivityId");

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230704111017_ActivityAttendee', '7.0.7');

COMMIT;

BEGIN TRANSACTION;

ALTER TABLE "Activities" ADD "IsCanceled" INTEGER NOT NULL DEFAULT 0;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230705070921_AddCanceledProperty', '7.0.7');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230707131248_PhotoEntityAdded', '7.0.7');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230713104915_Comments', '7.0.7');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20230718102005_FollowingEntityAdded', '7.0.7');
