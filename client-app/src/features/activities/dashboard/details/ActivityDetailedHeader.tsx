    ...
    return (
        ...
        <Segment.Group>
            <Segment basic attached='top' style={{padding: '0'}}>
                {
                    activity.isCanceled && <Label style={{position:'absolute', zIndex:1000, left: -14, top: 20}} 
                                ribbon 
                                color='red' 
                                content='Canceled'/>
                }
            ...
            <Segment clearing attached='bottom'>
                {
                    ...
                    <>
                        <Button color={activity.isCanceled ? 'green' : 'red'} 
                            floated='left' basic content={activity.isCanceled ? 'Re-activate Activity' : 'Cancel activity'}
